...
const Footer = () => {
  return (
    <footer className="max-w-7xl flex flex-col items-center px-5 mx-auto pt-20 divide-y divide-[#3F3E45]">
      <div className="flex flex-col gap-10 md:gap-0 items-center md:grid-cols-9 md:grid w-full px-5 mx-auto mb-10 md:mb-0 h-full md:h-[35vh]">
        ...
        <div className="flex items-start justify-between md:col-span-5 h-full w-[90%] md:w-full">
      ...
      <div className="flex items-center justify-between w-full mx-auto py-4 md:py-6 flex-col-reverse md:flex-row gap-3 md:gap-0 px-10">
