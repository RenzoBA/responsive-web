...
const Business = () => {
  return (
    <div className="max-w-6xl flex flex-col lg:flex-row h-screen justify-around lg:justify-between items-center mx-auto px-5 my-24 lg:my-0">
      ...
      <div className="flex flex-col justify-around items-center h-1/2 mt-6 lg:mt-0">
        {features.map((feature, i) => (
          <div
            className={
              "box-shadow rounded-xl feature-card px-4 py-3 max-w-md flex flex-row gap-5 items-center justify-center cursor-default"
            }
          >
